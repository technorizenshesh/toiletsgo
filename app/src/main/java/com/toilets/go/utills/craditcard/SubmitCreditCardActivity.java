package com.toilets.go.utills.craditcard;
...
import com.toilets.go.databinding.ActivitySubmitCreditCardBinding;
...
public class SubmitCreditCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activitySubmitCreditCardBinding = DataBindingUtil.setContentView(this,
                R.layout.activity_submit_credit_card);
        card = new Card();
        setSupportActionBar(activitySubmitCreditCardBinding.toolbar);

        View.OnClickListener onHelpClickListener = v -> Toast.makeText(SubmitCreditCardActivity.this, "The CVV Number (\"Card Verification Value\") is a 3 or 4 digit number on your credit and debit cards", Toast.LENGTH_LONG).show();
        ...
        activitySubmitCreditCardBinding.inputEditCardNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() != 0) {
                    flipToBlue();
                    activitySubmitCreditCardBinding.inputEditCardNumber.setHint("");
                }
            }
